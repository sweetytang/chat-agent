...
import {
    ...
    structuredOutputHighlightSchema,
...
export default function StructuredOutputCard({
    ...
    const highlights = Array.isArray(data.highlights)
        ? data.highlights.filter((highlight) => structuredOutputHighlightSchema.safeParse(highlight).success)
        : [];
    const sections = Array.isArray(data.sections)
        ? data.sections.filter((section) => structuredOutputPreviewSectionSchema.safeParse(section).success)
        : [];
    ...
    const comparisonRows = Array.isArray(data.comparisonTable?.rows)
        ? data.comparisonTable.rows.filter((row) => structuredOutputComparisonRowSchema.safeParse(row).success)
        : [];
