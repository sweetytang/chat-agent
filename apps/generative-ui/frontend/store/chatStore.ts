...
import { buildBranchingSessionData, isRenderableChatMessage, sortHistoryChronologically } from "@frontend/services/chat/branching";
        ...
        const nextMessages =
            shouldKeepPendingUiState
                ...
                : data.messages.length > 0 || data.isLoading
                    ? data.messages.filter(isRenderableChatMessage)
