...
import { getCurrentWeather, getForecastWeather } from "./qweatherClient.js";
...
export const getWeather = tool(
    ...
    {
        name: "get_weather",
        description: "Get weather for a location using QWeather. Prefer this tool for weather questions, including current conditions and short-term daily forecast like today, tomorrow, or the next 3 days. Do not use web_search for normal weather queries unless the user explicitly asks for web sources or news coverage.",
        schema: z.object({
